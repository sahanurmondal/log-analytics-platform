 ...
 */
public class FindLongestSubstringWithAtMostKUniqueCharacters {
    ...
    public static void main(String[] args) {
        FindLongestSubstringWithAtMostKUniqueCharacters solution = new FindLongestSubstringWithAtMostKUniqueCharacters();
        System.out.println(solution.lengthOfLongestSubstringKDistinct("aabbcc", 2)); // 4
        System.out.println(solution.lengthOfLongestSubstringKDistinct("aaabbcc", 1)); // 3
        // Edge Case: k == 0
        ...
        System.out.println(solution.lengthOfLongestSubstringKDistinct(s, 1)); // 100000

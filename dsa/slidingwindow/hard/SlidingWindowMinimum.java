...
/**
 * Sliding Window Minimum (Advanced Variation)
 * 
 * Description: Given an array nums and a window size k, return the minimum
...
public class SlidingWindowMinimum {
    ...
    public List<Integer> minSlidingWindowVariable(int[] nums, int[] windowSizes) {
    ...
    public static void main(String[] args) {
        SlidingWindowMinimum solution = new SlidingWindowMinimum();

        // Test case 1: Basic case
        int[] nums1 = { 1, 3, -1, -3, 5, 3, 6, 7 };
        int k1 = 3;
        System.out.println("Test 1 - nums: " + Arrays.toString(nums1) + ", k: " + k1);
        System.out.println("Result: " + Arrays.toString(solution.minSlidingWindow(nums1, k1)));

        // Test case 2: Variable window sizes
        int[] windowSizes = { 2, 3 };
        System.out.println("\nTest 2 - Variable window sizes:");
        System.out.println(solution.minSlidingWindowVariable(nums1, windowSizes));

        // Test case 3: Moving maximum
        System.out.println("\nTest 3 - Moving maximum:");
        ...
        // Edge cases
        System.out.println("\nEdge cases:");
        System.out.println("Empty nums: " + Arrays.toString(solution.minSlidingWindow(new int[] {}, 1)));
        System.out.println("Single element: " + Arrays.toString(solution.minSlidingWindow(new int[] { 5 }, 1)));
        System.out.println(
                "Window size equals array: " + Arrays.toString(solution.minSlidingWindow(nums1, nums1.length)));
        ...
        int[] result = solution.minSlidingWindow(large, 5000);

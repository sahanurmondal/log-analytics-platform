...
/**
 * Advanced Variation: Maximum Sum Path Between Two Leaves
 * 
 ...
 * 
 * Follow-up Questions:
 * 1. Can you find the actual path between leaves?
 * 2. Can you handle trees with only one leaf?
 * 3. Can you find k maximum paths between leaves?
 */
public class FindMaximumSumPathBetweenLeaves {
    ...
    public static void main(String[] args) {
        FindMaximumSumPathBetweenLeaves solution = new FindMaximumSumPathBetweenLeaves();

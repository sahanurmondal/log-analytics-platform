...
/**
 * LeetCode 270: Closest Binary Search Tree Value (Medium Variant)
 ...
 */
public class FindClosestValueInBSTMedium {
    ...
    // Approach 3: Lower and Upper Bound approach - O(h) time, O(1) space
    ...
    public static void main(String[] args) {
        FindClosestValueInBSTMedium solution = new FindClosestValueInBSTMedium();
        ...
        // Test Case 3: Approach comparison
        System.out.println("=== Test Case 3: Approach Comparison ===");
        TreeNode testRoot = solution.buildBST(new int[] { 8, 3, 10, 1, 6, 14, 4, 7, 13 });
        double target = 5.5;

        System.out.println("Target: " + target);
        System.out.println("Iterative: " + solution.closestValue(testRoot, target));
        System.out.println("Recursive: " + solution.closestValueRecursive(testRoot, target));
        System.out.println("Bounds: " + solution.closestValueBounds(testRoot, target));
        System.out.println();

...
/**
 * Variation: Find Kth Smallest Sum Subarray
 *
 * Description:
 * Given an array, find the kth smallest sum of contiguous subarrays.
 *
 * Constraints:
 * - 1 <= nums.length <= 10^5
 * - -10^9 <= nums[i] <= 10^9
 ...
 */
public class FindKthSmallestSumSubarray_fixed {
    ...
    public static void main(String[] args) {
        FindKthSmallestSumSubarray_fixed solution = new FindKthSmallestSumSubarray_fixed();
